...
parser.add_argument(
    "-n", "--number", type=str, help="The number of test cases that will be downloaded"
)
parser.add_argument(
    "-o", "--outpath", type=str, help="The output path of the test case"
)
...
# download test cases
urls = [
    ["https://zenodo.org/record/8222852/files/cali2017.tar.gz", "cali2017.tar.gz"],
